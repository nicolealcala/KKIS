...
$queryUnregisteredVoter= "SELECT * FROM `residents` WHERE `voter_type` = 'Unregistered'";
$resultUnregisteredVoter = executeQuery($queryUnregisteredVoter);
?>
                ...
                <div class="sectionDiv mx-0 mt-4" id="sectionKabataan">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            while ($rowUnregisteredVoter = mysqli_fetch_array($resultUnregisteredVoter)) {
                                echo '
                                
                                <tr>
                                        <td class="entryRow" scope="col" data-label="Name">' . $rowUnregisteredVoter
                    ['last_name'] . ' ' . $rowUnregisteredVoter
                    ['first_name'] . ' ' . $rowUnregisteredVoter
                    ['middle_name'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Gender">' . $rowUnregisteredVoter
                    ['gender_preference'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Age">' . $rowUnregisteredVoter
                    ['age'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Birthday">' . $rowUnregisteredVoter
                    ['birthday'] . '</td>
                                        <td class="entryRow" scope="col" data-label=Marital Status"">' . $rowUnregisteredVoter
                    ['marital_status'] . '</td>
                                        <td class="entryRow" scope="col" data-label="ContactNo.">' . $rowUnregisteredVoter
                    ['contact_no'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Purok">' . $rowUnregisteredVoter
                    ['purok'] . '</td>
                                        <td class="entryRow text-center" scope="col" data-label="Actions">
                                            <div class="row gy-2 mx-0" height="100%">
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-warning actionBtn" role="button" data-bs-toggle="modal" data-bs-target="#viewMore' . $rowUnregisteredVoter
                                ['resident_id'] . '" data-id="' . $rowUnregisteredVoter
                                ['rencrypted_id'] . '" href="#viewMore"><i class="fa-regular fa-eye"></i></a> 
                                                </div>
                                            
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-primary actionBtn" href="updateEntry.php?residentID=' . $rowUnregisteredVoter
                                ['rencrypted_id'] . 'role="button" aria-pressed="true"><i class="fa-solid fa-pen"></i></a>
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    ...
                                                    if ($("#deleteEntry").click(function(){
                                                        Swal.fire({
                                                            icon: "warning",
                                                            title: "Are you sure?",
                                                            text: "Deleting"' . $rowUnregisteredVoter
                                        ['last_name'] . ' ' . $rowUnregisteredVoter
                                        ['first_name'] . ' ' . $rowUnregisteredVoter
                                        ['middle_name'] . '" will completely remove this record.",
                                                        }).then((result) => {
