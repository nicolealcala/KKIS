...
$queryChildren = "SELECT  *, DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 AS `age` FROM `residents` WHERE DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 < 15";
$resultChildren = executeQuery($queryChildren);
?>
                ...
                <div class="sectionDiv mx-0 mt-4" id="sectionKabataan">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            while ($rowChildren = mysqli_fetch_array($resultChildren )) {
                                echo '
                                
                                <tr>
                                        <td class="entryRow" scope="col" data-label="Name">' . $rowChildren['last_name'] . ' ' . $rowChildren['first_name'] . ' ' . $rowChildren['middle_name'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Gender">' . $rowChildren['gender_preference'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Age">' . $rowChildren['age'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Birthday">' . $rowChildren['birthday'] . '</td>
                                        <td class="entryRow" scope="col" data-label=Marital Status"">' . $rowChildren['marital_status'] . '</td>
                                        <td class="entryRow" scope="col" data-label="ContactNo.">' . $rowChildren['contact_no'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Purok">' . $rowChildren['purok'] . '</td>
                                        <td class="entryRow text-center" scope="col" data-label="Actions">
                                            <div class="row gy-2 mx-0" height="100%">
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-warning actionBtn" role="button" data-bs-toggle="modal" data-bs-target="#viewMore' . $rowChildren['resident_id'] . '" data-id="' . $rowChildren['rencrypted_id'] . '" href="#viewMore"><i class="fa-regular fa-eye"></i></a> 
                                                </div>
                                            
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-primary actionBtn" href="updateEntry.php?residentID=' . $rowChildren['rencrypted_id'] . 'role="button" aria-pressed="true"><i class="fa-solid fa-pen"></i></a>
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    ...
                                                    if ($("#deleteEntry").click(function(){
                                                        Swal.fire({
                                                            icon: "warning",
                                                            title: "Are you sure?",
                                                            text: "Deleting"' . $rowChildren['last_name'] . ' ' . $rowChildren['first_name'] . ' ' . $rowChildren['middle_name'] . '" will completely remove this record.",
                                                        }).then((result) => {
