...
//KABATAAN --------------
$queryKabataan = "SELECT  *, CONCAT(`last_name`, ', ', `first_name`, ' ', `middle_name`) AS `full_name`, DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 AS `age` FROM `residents` WHERE DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 BETWEEN 15 AND 30";
        ...
        <div class="container-fluid content" id="contentID">
            <div class="sectionDiv">
                ...
                <div class="sectionDiv mx-0 mt-4" id="sectionKabataan">
                    ...
                    <!-- Actual table -->
                    <table class="table table-stripped table-bordered dataTable responsive display nowrap no-footer dtr-inline collapsed" role="grid" cellspacing="0" id="kabataanTbl" style="width:100%">
                        ...
                        <tbody>
                            ...
                            while ($rowKabataan = mysqli_fetch_array($resultKabataan)) {
                                $kabataanName = $rowKabataan['full_name'];
                                echo '
                                
                                <tr>
                                        <td class="entryRow" scope="col" data-label="Name">' . $rowKabataan['full_name'] . '</td>
                                                    ...
                                                    <script>
                                                        function warning(){
                                                            ...
                                                            Swal.fire({
                                                                icon: "warning",
                                                                title: "Are you sure?",
                                                                text: "Deleting ' . $kabataanName . ' will completely remove this record.",
                                                            }).then((result) => {
                                                                if (result.isConfirmed) {
                                                                window.location.href = "./profiles-kabataan.php";
                                                                }
                                                            });
                                                        };
                                                    </script>
