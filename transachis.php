...
<body style="backdrop-filter: opacity(1);border-radius: 0px;border-color: var(--bs-white);">
    ...
    <h1 id="title" class="title" style="font-weight: bold;font-family: Poppins;font-size: 3em;">Transaction History</h1><img src="assets/img/decorative.png" width="350" height="7" style="margin-right: 11px;padding-right: 166px;padding-left: 0px;margin-left: 80px;"><!-- Start: 1 Row 3 Columns -->
    <div class="container">
    ...
    <div id= "wrapper" class="row" style="width: 100%;">
        <div class="transac-table col-sm-11 col-md-11 col-lg-10 col-xl-11 col-xxl-11 mt-xxl-4 mt-xl-4 mt-lg-4 mt-md-4 mt-sm-4 mt-4 d-none d-lg-block" id="transac-table">
