  ...
  <body>
    <div class="sidePanel">
      ...
      <div class="userType row mx-0 mt-4 mb-5 gy-3">
        <div class="col-12">
          <img
            class="adminImg img-fluid mx-auto d-block"
            src="https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg?w=826&t=st=1672735069~exp=1672735669~hmac=0529aef602e66030ba048e23a9f7c779395717621976b3edc7b25545b41089f8"
            alt=""
          />
        </div>
        <div class="col-12">
          <span class="adminName mx-auto d-block text-center my-1"
            >Daniel Gecale</span
          >
          <span class="adminType mx-auto d-block text-center"
      ...
      <div class="genSettings">
        <div class="row mx-0 mt-4 mb-5 gy-2">
          ...
          <div class="col-12 d-block align-items-center">
            <a href="#tableOfContents" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="tableOfContents" id="userManual-link">User Manual<i class="fa-solid fa-caret-down ms-2"></i><i class="fa-solid fa-caret-up ms-2 d-none"></i></a>
