...
<body>
    ...
    <div class="row top-panel">
        ...
        <div class="dashboard-title col back-btn col-md-5 col-sm-1 col-xs-3"
            ...
            <h1 class="title" >Unemployed</h1><img class="gradient-line" style="padding-right: 23px; padding-left: 60px;margin-bottom: 15px;padding-bottom: 20px;"
