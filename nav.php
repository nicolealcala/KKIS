...
<body>
    ...
    <div id="sideNav" class="divSideNav"><label class="form-label" id="toggle" style="margin-bottom: 0px;" for="checkSide"><img src="assets/img/ToggleTransparent.svg" width="" height=""></label>
        ...
        <a id="linkSideResiProf" href="residentsProfile.php">
            <div class="divSideTab"><img src="./assets/img/navIcons/ResiProf.svg" width="51" height="47"><span class="sideTabName">Residents Profile</span></div>
        </a>
    ...
    <div class="divNavMenu">
        ...
        <a href="residentsProfile.php">
            <div class="divTopTab" id="linkTopResiProf"><img src="./assets/img/navIcons/mobResiProf.svg"><span>Residents Profile</span></div>
        </a>
        <a href="addEntry.php">
