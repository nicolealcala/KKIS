...
$querySeniors = "SELECT  *, DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 AS `age` FROM `residents` WHERE DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 > 59";
$resultSeniors = executeQuery($querySeniors);
?>
                ...
                <div class="sectionDiv mx-0 mt-4" id="sectionKabataan">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            while ($rowSeniors = mysqli_fetch_array($resultSeniors)) {
                                echo '
                                
                                <tr>
                                        <td class="entryRow" scope="col" data-label="Name">' . $rowSeniors['last_name'] . ' ' . $rowSeniors['first_name'] . ' ' . $rowSeniors['middle_name'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Gender">' . $rowSeniors['gender_preference'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Age">' . $rowSeniors['age'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Birthday">' . $rowSeniors['birthday'] . '</td>
                                        <td class="entryRow" scope="col" data-label=Marital Status"">' . $rowSeniors['marital_status'] . '</td>
                                        <td class="entryRow" scope="col" data-label="ContactNo.">' . $rowSeniors['contact_no'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Purok">' . $rowSeniors['purok'] . '</td>
                                        <td class="entryRow text-center" scope="col" data-label="Actions">
                                            <div class="row gy-2 mx-0" height="100%">
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-warning actionBtn" role="button" data-bs-toggle="modal" data-bs-target="#viewMore' . $rowSeniors['resident_id'] . '" data-id="' . $rowSeniors['rencrypted_id'] . '" href="#viewMore"><i class="fa-regular fa-eye"></i></a> 
                                                </div>
                                            
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-primary actionBtn" href="updateEntry.php?residentID=' . $rowSeniors['rencrypted_id'] . 'role="button" aria-pressed="true"><i class="fa-solid fa-pen"></i></a>
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    ...
                                                    if ($("#deleteEntry").click(function(){
                                                        Swal.fire({
                                                            icon: "warning",
                                                            title: "Are you sure?",
                                                            text: "Deleting"' . $rowSeniors['last_name'] . ' ' . $rowSeniors['first_name'] . ' ' . $rowSeniors['middle_name'] . '" will completely remove this record.",
                                                        }).then((result) => {
