                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            while ($rowResidents = mysqli_fetch_array($resultResidents)) {
                                ...
                                <tr>
                                        <td class="entryRow" scope="col" data-label="Name">' . $rowResidents['last_name'] . ' ' . $rowResidents['first_name'] . ' ' . $rowResidents['middle_name'] . '</td>
                                        ...
                                        <td class="entryRow text-center" scope="col" data-label="Actions">
                                            <div class="row gy-2 mx-0" height="100%">
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-warning actionBtn" role="button" data-bs-toggle="modal" data-bs-target="#viewMore' . $rowResidents['resident_id'] . '" data-id="' . $rowResidents['rencrypted_id'] . '" href="#viewMore"><i class="fa-regular fa-eye"></i></a> 
                                                </div>
                                            
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-primary actionBtn" href="updateEntry.php?residentID=' . $rowResidents['rencrypted_id'] . 'role="button" aria-pressed="true"><i class="fa-solid fa-pen"></i></a>
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    ...
                                                    if ($("#deleteEntry").click(function(){
                                                        Swal.fire({
                                                            icon: "warning",
                                                            title: "Are you sure?",
                                                            text: "Deleting"' . $rowResidents['last_name'] . ' ' . $rowResidents['first_name'] . ' ' . $rowResidents['middle_name'] . '" will completely remove this record.",
                                                        }).then((result) => {
