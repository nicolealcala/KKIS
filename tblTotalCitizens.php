...
$queryTotalCitizens = "SELECT *, CONCAT(`last_name`, ', ', `first_name`, ' ', `middle_name`) AS  full_name, DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') + 0 AS age, households.head_remarks FROM `residents` RIGHT JOIN `households` ON residents.household_id = households.household_id WHERE DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), birthday)), '%Y') >= 0 "; //query to select all data from table
$queryTotalCitizensResult = executeQuery($queryTotalCitizens); //execute query
        ...
        <header class="d-none d-lg-block" id="lgHeader">
            <div class="row mx-0" id="headerRow">
                <div class="col-md-8 col-12 d-flex justify-content-start align-items-center">
                    ...
                    <span class="pageTitle">Total Citizens</span>
                </div>
            ...
            <div class="sectionDiv">
                ...
                <div class="sectionDiv mx-0 mt-4" id="sectionKabataan">
                    ...
                    <table class="table table-stripped table-bordered dataTable responsive display nowrap no-footer dtr-inline collapsed printTable" role="grid" cellspacing="0" id="kabataanTbl" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            while ($totalCitizens = mysqli_fetch_array($queryTotalCitizensResult)) {
                                $totalCitizensID = $totalCitizens["resident_id"]; //get resident id
                                $totalCitizensEID = $totalCitizens["rencrypted_id"];
                            ?>

                                <tr>

                                    <td id="fullName" class="entryRow" scope="col" data-label="Name"><?php echo $totalCitizens["full_name"]; ?></td>

                                    <td id="gender" class="entryRow" scope="col" data-label="Gender"><?php echo $totalCitizens["gender_preference"]; ?></td>

                                    <td id="age" class="entryRow" scope="col" data-label="Age"><?php echo $totalCitizens["age"]; ?></td>

                                    <td id="birthday" class="entryRow" scope="col" data-label="Birthdate"><?php echo $totalCitizens["birthday"]; ?></td>

                                    <td id="civilStatus" class="entryRow" scope="col" data-label="Civil status"><?php echo $totalCitizens["marital_status"]; ?></td>

                                    <td id="contactNo" class="entryRow" scope="col" data-label="Contact No."><?php echo $totalCitizens["contact_no"]; ?></td>


                                    <td id="purok" class="entryRow" scope="col" data-label="Purok"><?php echo $totalCitizens["purok"]; ?></td>

                                    <td id="remarks" class="entryRow" scope="col" data-label="Remarks"><?php echo $totalCitizens["head_remarks"]; ?></td>
                                    ...
                                    <td id="actions" class="entryRow" scope="col" data-label="Actions">
                                        <div class="row mx-0 p-0">
                                            ...
                                            <div class="col-lg-12 col-12 d-flex justify-content-center align-items-center p-0">
                                                <a class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#viewMore<?php echo $totalCitizens["resident_id"]; ?>" data-id="<?php echo $totalCitizens["resident_id"]; ?>" href="#viewMore">View More</a>
                                            </div>
                                        </div>  
                                    </td>
                                ...
                                <!-- Kabataan Modal -->
                                <div class="modal fade" role="dialog" tabindex="1" id="viewMore<?php echo $totalCitizens["resident_id"]; ?>">
                                            ...
                                            <div class="modal-body m-0" id="modalBodyID">
                                                <div class="row rowContainer mx-2" id="modalRow1">
                                                    <div class="col col-lg-8 col-md-8 col-sm-12 col-12" id='textDiv'>
                                                        <p class="textName lastName w-100 my-1" id="textNameID"><?php echo $totalCitizens["full_name"]; ?></p>
                                                        <p class="textGender w-100 my-1 mt-2" id="textAgeID"><?php echo $totalCitizens["age"]; ?> YEARS OLD</p>
                                                        <p class="textAge w-100 my-1" id="textGenderID"><?php echo $totalCitizens["gender_preference"]; ?></p>
                                                    </div>
                                                    ...
                                                    <div class="col" id="row2Body">
                                                        <div class="row gy-1" id="row2Content">
                                                            <div class="col-6" id="row2ContentDiv">
                                                                ...
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["birthday"]; ?></p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">Voter Type:</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["voter_type"]; ?></p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">Birthplace:</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["birthplace"]; ?></p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">Contact No:</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["contact_no"]; ?></p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">Marital Status:</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["marital_status"]; ?></p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">Religion:</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["religion"]; ?></p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">Disability:</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["disability"]; ?></p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">Organization/s (if any):</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["organization"]; ?></p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">House No./St./Subd.:</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["house_address"]; ?>.&nbsp;</p>
                                                            </div>
                                                            <div class="col-6" id="row2ContentDiv">
                                                                <label class="form-label modalLabel">Purok:</label>
                                                                <p class="textRetrieved" id="textRetrievedID"><?php echo $totalCitizens["purok"]; ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row rowContainer my-4 mx-2" id="modalRow2">
                                                    ...
                                                    <?php
                                                    $employmentCheck = "SELECT * FROM employment_info WHERE resident_id = $totalCitizensID"; //check if resident has employment info
                                                    $employmentCheckResult = executeQuery($employmentCheck);

                                                    $educationCheck = "SELECT * FROM educational_info WHERE resident_id = $totalCitizensID"; //check if resident has educational info
                                                    ...
                                                    $household_id = $totalCitizens["household_id"]; //getting the household id of the user
