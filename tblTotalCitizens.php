...
$queryTotalCitizens = "SELECT * FROM `residents`";
$resultTotalCitizens = executeQuery($queryTotalCitizens);
?>
                ...
                <div class="sectionDiv mx-0 mt-4" id="sectionKabataan">
                    ...
                    <table
                        ...
                        <tbody>
                            ...
                            while ($rowTotalCitizens = mysqli_fetch_array($resultTotalCitizens)) {
                                echo '
                                
                                <tr>
                                        <td class="entryRow" scope="col" data-label="Name">' . $rowTotalCitizens['last_name'] . ' ' . $rowTotalCitizens['first_name'] . ' ' . $rowTotalCitizens['middle_name'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Gender">' . $rowTotalCitizens['gender_preference'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Age">' . $rowTotalCitizens['age'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Birthday">' . $rowTotalCitizens['birthday'] . '</td>
                                        <td class="entryRow" scope="col" data-label=Marital Status"">' . $rowTotalCitizens['marital_status'] . '</td>
                                        <td class="entryRow" scope="col" data-label="ContactNo.">' . $rowTotalCitizens['contact_no'] . '</td>
                                        <td class="entryRow" scope="col" data-label="Purok">' . $rowTotalCitizens['purok'] . '</td>
                                        <td class="entryRow text-center" scope="col" data-label="Actions">
                                            <div class="row gy-2 mx-0" height="100%">
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-warning actionBtn" role="button" data-bs-toggle="modal" data-bs-target="#viewMore' . $rowTotalCitizens['resident_id'] . '" data-id="' . $rowTotalCitizens['rencrypted_id'] . '" href="#viewMore"><i class="fa-regular fa-eye"></i></a> 
                                                </div>
                                            
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    <a class="btn btn-primary actionBtn" href="updateEntry.php?residentID=' . $rowTotalCitizens['rencrypted_id'] . 'role="button" aria-pressed="true"><i class="fa-solid fa-pen"></i></a>
                                                </div>
                                                ...
                                                <div class="col-12 col-lg-4 d-flex justify-content-center align-items-center">
                                                    ...
                                                    if ($("#deleteEntry").click(function(){
                                                        Swal.fire({
                                                            icon: "warning",
                                                            title: "Are you sure?",
                                                            text: "Deleting"' . $rowTotalCitizens['last_name'] . ' ' . $rowTotalCitizens['first_name'] . ' ' . $rowTotalCitizens['middle_name'] . '" will completely remove this record.",
                                                        }).then((result) => {
                                ...
                                <div class="modal-body m-0" id="modalBodyID">
                                    <div class="row rowContainer mx-2" id="modalRow1">
                                        <div class="col col-lg-8 col-md-8 col-sm-12 col-12" id="textDiv">
                                            <p class="textName lastName w-100 my-1" id="textNameID">' . $rowResidents['last_name'] . ', ' . $rowResidents['first_name'] . ' ' . $rowResidents['middle_name'] . '</p>
